...
{
    /// <inheritdoc />
    public partial class AddInventoryManagementFeatures : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LowStockEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LowStockEvents_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LowStockEvents_CreatedAt",
                table: "LowStockEvents",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_LowStockEvents_IsAcknowledged",
                table: "LowStockEvents",
                column: "IsAcknowledged");

            migrationBuilder.CreateIndex(
                name: "IX_LowStockEvents_ProductId",
                table: "LowStockEvents",
                column: "ProductId");
